...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://vp0htlrzdg.execute-api.us-west-2.amazonaws.com/Dev';
    ...
    apigClient.uploadPhotoIdPut = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['photoId', 'x-amz-meta-customLabels'], ['body']);
        
        var uploadPhotoIdPutRequest = {
            verb: 'put'.toUpperCase(),
            path: pathComponent + uritemplate('/upload/{photoId}').expand(apiGateway.core.utils.parseParametersToObject(params, ['photoId', ])),
        ...
        return apiGatewayClient.makeRequest(uploadPhotoIdPutRequest, authType, additionalParams, config.apiKey);
    };
